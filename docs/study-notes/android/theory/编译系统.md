...
![img](编译系统.assets/17308789593225.png)
...
![img](编译系统.assets/17308789593211.png)
...
![img](编译系统.assets/17308789593212.png)
...
![img](编译系统.assets/17308789593213.png)

然后中途可能要设置git邮箱和用户名

![img](编译系统.assets/17308789593214.png)
...
![img](编译系统.assets/173087905576616.png)
...
![image-20241105213602538](编译系统.assets/image-20241105213602538.png)
...
![img](编译系统.assets/173087917250324.png)

如果使用emulator有个报错

![img](编译系统.assets/173087917250425.png)

这是因为没有kvm加速器，安装一下就好了

![img](编译系统.assets/173087917250426.png)
...
![image-20241106162611260](编译系统.assets/image-20241106162611260.png)

记得先执行`source build/envsetup.sh`才会把你的改动添加进来，再使用lunch命令就可以发现我们定义的已经成功添加进来了：

![image-20241106162804341](编译系统.assets/image-20241106162804341.png)
...
![img](编译系统.assets/173088099269233.png)
...
![image-20241106212113830](编译系统.assets/image-20241106212113830.png)
...
![image-20241106171054662](编译系统.assets/image-20241106171054662.png)
...
![image-20241106171348491](编译系统.assets/image-20241106171348491.png)
...
![image-20241106172701214](编译系统.assets/image-20241106172701214.png)
...
- 包含了product.mk文件
  ...
  ![image-20241106172911423](编译系统.assets/image-20241106172911423.png)
...
![image-20241106203045637](编译系统.assets/image-20241106203045637.png)
...
![image-20241106213634482](编译系统.assets/image-20241106213634482.png)

这俩文件分别代表 **32 位优先**的启动模式和 **64 位优先**的启动模式。zygote的Android.mk中做了同时编译32位和64位程序的配置。

以init.zygote64_32.rc为例，他所属的进程为app_process64

![image-20241106213901394](编译系统.assets/image-20241106213901394.png)
